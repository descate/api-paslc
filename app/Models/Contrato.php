...
class Contrato extends Model
{
    ...
    public function rolContrato()
    {
        return $this->belongsTo(RolContrato::class, 'rol_contrato_id');
    }

    public function valorizaciones()
    {
        return $this->hasMany(Valorizacion::class, 'contrato_id');
    }
    ...
    {
        return $this->belongsTo(ModalidadEjecucion::class, 'modalidad_ejecucion_id');
    }

    public function procedimientoSeleccion()
    {
        return $this->belongsTo(ProcedimientoSeleccion::class, 'procedimiento_seleccion_id');
    }
    ...
    public function sistemaContratacion()
    {
        return $this->belongsTo(SistemaContratacion::class, 'sistema_contratacion_id');
    }
}
